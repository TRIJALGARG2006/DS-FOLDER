...
class StackADT:
    ...
    # _init_ = special function (constructor) that runs automatically when an object is created
...
# if = condition check
# _name_ = special built-in variable in Python
# "_main_" = special string meaning "this file is being run directly"
